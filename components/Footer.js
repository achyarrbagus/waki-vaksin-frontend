        ...
        <footer className="w-full">
            <div className="container mx-auto max-w-screen-md bg-white pt-5">
                <div className="flex items-center py-2 px-4">
                    ...
                    <div className="mx-2">
                        <div className="flex">
                            <h2 className="text-gray-600 text-xl font-bold">{switchDomain(i18n.language)}</h2>
                        </div>
                        <div className="flex">
                ...
                <div className="flex justify-center items-center text-center py-2">
                    <p className="text-gray-600 text-md">Copyright © 2022 {switchName(i18n.language)}. All Rights Reserved</p>
                </div>
            </div>
        </footer >
    );
