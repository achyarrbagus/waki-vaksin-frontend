...
import { flu_id, flu_en } from '@/constant/flu'
...
export async function getStaticProps({ locale }) {
    return {
        props: {
            ...(await serverSideTranslations(locale, ["common", "flu"]))
        }
    };
}
...
export default function One() {
    ...
    const { t, i18n } = useTranslation(["common", "flu"]);
    ...
    const onSubmitForm = async (values) => {
        ...
        router.push('/step/flu/two')
    }

    const symptoms = i18n.language == 'id' ? flu_id : flu_en;
    return (
                        ...
                        <Form className="flex flex-col justify-between h-full w-full pb-6">
                            <div className='flex flex-col'>
                                <div className='py-4 my-5'>
                                    <h1 className='text-left text-3xl text-gray-700 font-black'>{t("title", { ns: 'flu' })}</h1>
                                    <p className='text-md text-gray-600 text-sm font-normal'>{t("step-1-title-3")}</p>
                                </div>
                                <div className='mb-4 w-full'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("q1", { ns: 'flu' })}</label>
                                    <Field
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("q2", { ns: 'flu' })}</label>
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("q3", { ns: 'flu' })}</label>
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("q4", { ns: 'flu' })}</label>
                                    <p className='text-md text-gray-600 text-sm font-normal mb-2'>{t("q4-2", { ns: 'flu' })}</p>
                                ...
                                <div className='mb-40'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("q5", { ns: 'flu' })}</label>
                                    <div className='flex flex-row form-check'>
                                        <label className='text-sm align-middle form-check-label inline-block'>
