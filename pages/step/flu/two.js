...
export default function Two() {
    ...
    return (
        <Layout title={t("step-2-title")} back={'/step/flu/one'}>
                    ...
                    {({ errors, touched }) => (
                        <Form className="flex flex-col justify-between min-h-screen pb-6 w-full">
                            <div className='flex flex-col'>
                                ...
                                <div className='py-2'>
                                    <p className='font-bold text-gray-700 text-sm'>{t("qr1", { ns: 'flu' })}</p>
                                </div>
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("qr2", { ns: 'flu' })}</label>
