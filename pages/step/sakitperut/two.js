...
import { sakitperut_risk_id, sakitperut_risk_en, sakitperut_risk2_id, sakitperut_risk2_en } from "@/constant/sakitperut"
...
export default function Two() {
    ...
    const onSubmitForm = async (values) => {
        ...
        context.setqr(data)
        context.seturls('sakitperut')
        router.push('/step/data_diri')
    }

    const risk = i18n.language == 'id' ? sakitperut_risk_id : sakitperut_risk_en;
    const risk2 = i18n.language == 'id' ? sakitperut_risk2_id : sakitperut_risk2_en;

    return (
        <Layout title={t("step-2-title")} back={'/step/sakitperut/one'}>
                    ...
                    {({ errors, touched }) => (
                        <Form className="flex flex-col justify-between min-h-screen pb-6 w-full">
                            <div className='flex flex-col mb-32'>
                                ...
                                <div className='py-2'>
                                    <p className='font-bold text-gray-700 text-sm'>{t("risk-desc", { ns: 'sakitperut' })}</p>
                                </div>
                                <hr className=' decoration-dashed mb-3' />
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("qr1", { ns: 'sakitperut' })}</label>
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("qr2", { ns: 'sakitperut' })}</label>
                                    <ul className="list-decimal">
                                        {
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("qr3", { ns: 'sakitperut' })}</label>
                                    <div className='flex flex-row form-check'>
                                        <label className='text-sm align-middle form-check-label inline-block'>
                                    ...
                                    <div className="mt-3">
                                        <Field name="qr3_1" className="w-full py-2 px-3 rounded-lg text-sm text-gray-700 bg-white border border-gray-200 overflow-hidden focus:outline-none focus:border-primary-700 focus:ring-primary-700 focus:ring-1" type="text" placeholder={t("step-2-title-4-2")} />
                                    </div>
                                </div>
