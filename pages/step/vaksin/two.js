...
import { vaksin_risk_id, vaksin_risk_en } from "@/constant/vaksin"
...
export default function Two() {
    ...
    const onSubmitForm = async (values) => {
        ...
        context.setqr(data)
        context.seturls('vaksin')
        router.push('/step/data_diri')
    }

    const risk = i18n.language == 'id' ? vaksin_risk_id : vaksin_risk_en;

    return (
        <Layout title={t("step-2-title")} back={'/step/vaksin/one'}>
                    ...
                    {({ errors, touched }) => (
                        <Form className="flex flex-col justify-between min-h-screen pb-6 w-full">
                            <div className='flex flex-col mb-32'>
                                ...
                                <div className='py-2'>
                                    <p className='font-bold text-gray-700 text-sm'>{t("risk-desc", { ns: 'vaksin' })}</p>
                                </div>
                                <hr className=' decoration-dashed mb-3' />
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("qr1", { ns: 'vaksin' })}</label>
                                ...
                                <div className='mb-4'>
                                    <label className="block mb-1 font-bold text-gray-700 text-sm">{t("qr2", { ns: 'vaksin' })}</label>
                                    <div className='flex flex-row form-check'>
                                        <label className='text-sm align-middle form-check-label inline-block'>
