    ...
    <Layout title="Home">
      <div className="bg-primary-700 pb-4 flex-col">
        ...
        <div className="text-left text-white px-6 py-3">
          ...
          <p className="text-lg sm:text-md font-normal mt-2 ">
            {t("header-1")}
          </p>
          <h1 className="text-3xl sm:text-2xl font-bold text-white w-64 mt-3">
            {t("header-2")}
          </h1>
        ...
        <div className="p-5">
          {articles ? (
            <SliderUpdatedArticle data={articles} />
          ) : (
            <Skeleton count={8} />
          )}
        </div>
      ...
      <div className="bg-white flex flex-col px-6 pt-6">
        <p className="text-secondary-500 font-bold text-lg mb-3">
          {t("text-h-1")}
        </p>
        ...
        <p className="text-secondary-500 font-bold text-lg mt-6 mb-3">
          {t("text-h-4")}
        </p>
